    ...
    public static class Extensions
    {
        ...
        public static IServiceCollection ConfigureIdentityServer(this IServiceCollection services)
        {
            ...
            services
                ...
                .AddSingleton<ICorsPolicyService, CorsPolicyService>();
        ...
        private static AuthenticationBuilder AddCookie(this AuthenticationBuilder builder)
        {
        ...
        private static IServiceCollection AddIdentityStore(this IServiceCollection services)
        {
            var appSettings = services.BuildServiceProvider().GetRequiredService<AppSettings>();

            return services.AddDbContext<IdentityDbContext>(builder => builder.Connection(appSettings.ConnectionStrings.Database));
        }
